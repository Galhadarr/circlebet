      ...
      <div className="relative overflow-hidden bg-surface border border-border rounded-2xl p-8 shadow-sm">
        ...
        <div className="relative">
          <div className="flex items-center gap-3 mb-2">
            {circle.icon_url ? (
              <div className="relative w-12 h-12 rounded-full overflow-hidden flex-shrink-0 border border-border shadow-sm">
                <Image src={circle.icon_url} alt={circle.name} fill className="object-cover" />
              </div>
            ) : (
              <div className="w-12 h-12 rounded-full flex-shrink-0 bg-blue/10 border border-blue/20 flex items-center justify-center">
                <svg className="w-6 h-6 text-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>

...
function CircleIcon({ iconUrl, name }: { iconUrl: string | null; name: string }) {
  ...
  return (
    <div className="w-11 h-11 rounded-full flex-shrink-0 bg-blue/10 border border-blue/20 flex items-center justify-center">
      <svg className="w-5 h-5 text-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
